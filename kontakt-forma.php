...
if (isset($_POST["submit"]) && $_POST["submit"] == "sendEmail") {
    ...
    if (empty($formErrors)) {
        ...
        try {
            ...
            $mail->addAddress('jelocnik.boris@gmail.com', 'Boris Jelocnik');     // Add a recipient
            ...
            $mail->Body = $formData['subject'];
            $mail->AltBody = strip_tags($formData['subject']);
            ...
            <div class="row">
                <div class="col-xs-12">
                    <?php if (!empty($successMessage)) { ?>
                        <div class="alert alert-successs alert-dismissible" role="alert">
                ...
                <form action="" method="post" role="form" class="form container-fluid">
                    ...
                    <fieldset class="row">
                        <div class="col-md-6">
                            ...
                            <div class="g-recaptcha" data-sitekey="6LdNH0AUAAAAAMjny0TVfQJYkjGMEsO08rsmPhbQ"></div>
                            <div class="validation">
                                <?php
